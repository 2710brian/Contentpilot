...
/**
 * AEBG Product Affiliate URL Dynamic Tag
 */
class ProductAffiliateUrl extends Data_Tag {
    
    public function get_name() {
        return 'aebg-product-affiliate-url';
    }
    
    public function get_title() {
        return esc_html__( 'AEBG Product Affiliate URL', 'aebg' );
    }
    ...
    public function get_value( array $options = [] ) {
        ...
        if ( empty( $data ) || empty( $data['affiliate_url'] ) ) {
            return '';
        }
        
        // Return affiliate URL as string
        return esc_url( $data['affiliate_url'] );
    }
