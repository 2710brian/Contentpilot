 ...
 * @since 1.0.0
 */
class AEBG_Icon_List extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'AEBG Icon List', 'aebg' );
	}
	...
	protected function register_controls() {
		...
		// AI Content Prompt Toggle (unique names)
		$repeater->add_control(
			'aebg_iconlist_ai_enable',
			[
				'label' => esc_html__( 'Enable AI Content Generation', 'aebg' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => esc_html__( 'On', 'aebg' ),
				'label_off' => esc_html__( 'Off', 'aebg' ),
				'return_value' => 'yes',
				'default' => '', // Off by default
				'description' => esc_html__( 'When enabled, the prompt below will be used to generate content in the bulk generator. When off, the original item text will be used.', 'aebg' ),
			]
		);

		// AI Content Prompt Field (unique names)
		$repeater->add_control(
			'aebg_iconlist_ai_prompt',
			[
				'label' => esc_html__( 'AI Content Prompt', 'aebg' ),
				'type' => Controls_Manager::TEXTAREA,
				'description' => esc_html__( 'Enter a prompt for this item. Used by the bulk generator if enabled.', 'aebg' ),
				'condition' => [ 'aebg_iconlist_ai_enable' => 'yes' ],
			]
		);
